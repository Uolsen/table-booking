<div class="bg-white">
    <div class="relative">
                ...
                <div class="relative px-6 py-32 sm:py-40 lg:px-8 lg:py-56 lg:pr-0">
                    <div class="mx-auto max-w-2xl lg:mx-0 lg:max-w-xl">
                        ...
                        <h1 class="text-5xl font-semibold tracking-tight text-pretty text-gray-900 sm:text-7xl">
                            Restaurant Experiment</h1>
                        <p class="mt-8 text-lg font-medium text-pretty text-gray-500 sm:text-xl/8">Welcome to Restaurant
                            Experiment. You can easily reservate your table here.</p>
        ...
        <div class="bg-gray-50 lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
            <img src="{{ Vite::asset('resources/img/restaurant.webp') }}" alt="Restaurant image"
